                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col-md-3 mb-1'>
                                        <label>
                                            <input type='checkbox' name='features' value='$opt[id]' class='form-check-input me-1 shadow-none'>$opt[name]
                                        </label>
                                    </div>
                                    ";
                                    }
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class='col-md-3 mb-1'>
                                        <label>
                                            <input type='checkbox' name='facilities' value='$opt[id]' class='form-check-input me-1 shadow-none'>$opt[name]
                                        </label>
                                    </div>
                                    ";
                                    }
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="desc" rows="4" class="form-control shadow-none" style="resize:none;"
                                    required></textarea>
                            </div>

...
add_room_form.addEventListener('submit', function (e) {
    e.preventDefault(); // data submit but page not
    add_room();
});
function add_room() {
    ...
    data.append('features', JSON.stringify(features)); // json convert decot
    ...
    xhr.onload = function () {
        ...
        edit_room_form.elements['features'].forEach(el => {
            if (data.features.includes(Number(el.value))) {
                // console.log(el.value);
                //includes function array data check
                el.checked = true;
            }
        });
...
function rem_image(img_id, room_id) {
    ...
    data.append('rem_image', ''); //index value null
...
function thumb_image(img_id, room_id) {
    ...
    data.append('image_id', img_id);
    data.append('room_id', room_id);
    data.append('thumb_image', ''); //index value null
    ...
    xhr.onload = function () {
        ...
        if (this.responseText == 1) {
            ...
            alert('error', 'thumbnail not changed!');
        }
